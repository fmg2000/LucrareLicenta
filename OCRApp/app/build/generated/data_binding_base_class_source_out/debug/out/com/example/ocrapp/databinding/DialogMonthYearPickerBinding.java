...
public final class DialogMonthYearPickerBinding implements ViewBinding {
  ...
  private DialogMonthYearPickerBinding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
      @NonNull Button btnConfirm, @NonNull NumberPicker monthPicker,
  ...
  public static DialogMonthYearPickerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogMonthYearPickerBinding((LinearLayout) rootView, btnCancel, btnConfirm,
